...
public class Bombones {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        int nº_random_participantes = (int) Math.floor(Math.random() * participantes);
        System.out.println(nº_random_participantes);
        System.out.println("¿Cuantos bombones por cabeza?");
        int max_bombon = reader.nextInt();
        int nº_random_bombones = (int) Math.floor(Math.random() * max_bombon);
        System.out.println(nº_random_bombones);
        ...
        try {
            ...
            while (lector.hasNext()) {
                ...
                for (int i = 0; i < nº_random_participantes; i++) {
            ...
            for (String h : alumnado.keySet()) {
                System.out.println(h + "  " + alumnado.get(h));
            }
